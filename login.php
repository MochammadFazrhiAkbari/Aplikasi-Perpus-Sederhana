    ...
    <div class="login-box">
        ...
        <div class="card-header"><h3 class="text-center font-weight-light my-4">Login</h3>
            ...
            <div class="social-auth-links text-center">
                <p style="font-size: 11px;">Forgot password?</p>
                <div class="row">
                    <div class="col-xs-12">
                    <label class="small mb-1" for="regis">New User</label>
                        <button type="button" onclick="Register()" class="btn btn-block btn-warning btn-flat"><i class="fa fa-user-plus"></i> Register</button>
                    </div>
                </div>
            </div>
        </div>
