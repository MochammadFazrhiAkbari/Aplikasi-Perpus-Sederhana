<header class="main-header">
    ...
    <a href="dashboard" class="logo" style="font-family: 'Quicksand', sans-serif">
        ...
        ?>
        <span class="logo-lg"><b>Perpus Kami</b> <i class="fa fa-book"></i></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
        <!-- Sidebar toggle button-->
        <a href="../../assets/dist/img/avatar5.jpg" class="sidebar-toggle" data-toggle="push-menu" role="button">
            ...
            <ul class="nav navbar-nav">
                                ...
                                ?>
                                    <li>
                                        ...
                                        <a href="lihat-pesan?id_pesan=<?= $row_pesan1['id_pesan']; ?>">
                                            <div class="pull-left">
                                                <img src="../../assets/dist/img/avatar5.jpg" class="img-circle" alt="User Image">
                                            </div>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="../../assets/dist/img/avatar5.jpg" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!-- Menu Footer-->
                          ...
                          <li class="user-footer">
                            <a href="#Login" data-toggle="modal" data-target="#modalLogoutConfirm" class="btn btn-default btn-flat">Change Password</a>
                        </li>
                        <li class="user-footer">
